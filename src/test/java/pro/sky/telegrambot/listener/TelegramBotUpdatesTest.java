...
public class TelegramBotUpdatesTest {
    ...
    final UserChat testUser = new UserChat(123L, "Jack", "Sparrow", null, false, null);
    ...
    void processTest() {
        ...
        when(userChatService.getUserChatStatus(CHAT_ID)).thenReturn(BotState.START);
